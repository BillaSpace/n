...
async def get_thumb(videoid):
    ...
    try:
        ...
        now_playing_draw.rounded_rectangle(
            [(0, 0), (now_playing_width, now_playing_height)], radius=8, fill=(0, 0, 0, 180)
        )
        ...
        title_draw.rounded_rectangle(
            [(0, 0), (title_width + 2 * padding, title_height)], radius=8, fill=(0, 0, 0, 180)
        )
        ...
        info_draw.rounded_rectangle(
            [(0, 0), (info_width + 2 * padding, info_height)], radius=8, fill=(0, 0, 0, 180)
        )
        ...
        current_y = start_y
        draw.text(
            (start_x, current_y), "Now Playing", fill="white", stroke_width=1, stroke_fill="black", font=font2
        )
        ...
        for i, line in enumerate(info_lines):
            draw.text(
                (start_x, current_y), line, fill="white", stroke_width=1, stroke_fill="black", font=arial
            )
