...
/start : sᴛᴀʀᴛs ᴛʜᴇ ʙɪʟʟᴀ ᴍᴜsɪᴄ ʙᴏᴛ.
...
/song or /music [sᴏɴɢ ɴᴀᴍᴇ/ʏᴛ ᴜʀʟ] : ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴʏ ᴛʀᴀᴄᴋ ғʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ & Yᴏᴜᴛᴜʙᴇ ᴍᴜsɪᴄ ғᴏʀ ғʀᴇᴇ ɪɴ  ᴜᴘᴛᴏ 44ʜᴢ 16ʙɪᴛs ʟᴏsᴇʟᴇss ᴀᴜᴅɪᴏ 𝑄ᴜᴀʟɪᴛʏ ᴏʀ ᴏᴘᴜs ᴄᴏᴅᴇᴄ.
"""
